...
// Why does this work even without having a System constructor with a cpu_
// definition? cpu_ is just an empty object?;
...
vector<Process>& System::Processes() {
  ...
  std::vector<int> new_pids =
      {};  // pids which do no exist in the processes_ vector yet
  ...
  for (Process process : processes_) {
    result_pids.push_back(process.Pid());
  }
